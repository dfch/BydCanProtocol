...
namespace JkBms::Identifiers
{
    ...
    #pragma pack(push, 1)
    /// @brief Represents the Charge Over Current Delay in seconds of the BMS (1..60).
    struct tagChargeOverCurrentDelay
    {
    ...
    /// @brief Represents the Charge Over Current Delay in seconds of the BMS (1..60).
    using ChargeOverCurrentDelay = tagChargeOverCurrentDelay;
}
