...
namespace JkBms::Identifiers
{
    ...
    #pragma pack(push, 1)
    /// @brief Represents the Cell Under Voltage Protection Delay in seconds of the BMS (1..60).
    struct tagCellUnderVoltageProtectionDelay
    {
    ...
    /// @brief Represents the Cell Under Voltage Protection Delay in seconds of the BMS (1..60).
    using CellUnderVoltageProtectionDelay = tagCellUnderVoltageProtectionDelay;
}
