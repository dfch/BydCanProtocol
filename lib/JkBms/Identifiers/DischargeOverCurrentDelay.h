...
namespace JkBms::Identifiers
{
    ...
    #pragma pack(push, 1)
    /// @brief Represents the Discharge Over Current Delay in seconds of the BMS (1..60).
    struct tagDischargeOverCurrentDelay
    {
    ...
    /// @brief Represents the Discharge Over Current Delay in seconds of the BMS (1..60).
    using DischargeOverCurrentDelay = tagDischargeOverCurrentDelay;
}
